# Generated by Django 3.2 on 2024-07-02 18:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entity_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='authuser.entitytype')),
                ('permission_type', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='authuser.permissiontype')),
            ],
        ),
        migrations.AddField(
            model_name='entities',
        ...
        migrations.AddField(
            model_name='entities',
            name='parent',
            field=models.ForeignKey(blank=True, max_length=12, null=True, on_delete=django.db.models.deletion.CASCADE, to='authuser.entities'),
        ),
